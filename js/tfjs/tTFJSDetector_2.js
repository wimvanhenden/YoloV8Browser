...
const tTFJSDetector = (function () {
    ...
    async function detect(source, model, canvasRef) {
        ...
        const res = await model.net.execute(input);
    ...
    async function publicInit() {
        ...
        try {
            ...
            const yolov8 = await tf.loadGraphModel(`${window.location.href}${modelName}/model.json`, {
            ...
            console.log("WARM UP MODEL "+modelName);
            // warming up model
